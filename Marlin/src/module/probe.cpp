...
//   //MARIO: old Longer code. Maybe do_blocking_move_to_z() is better than do_z_clearance(). This should be checked
// //   #ifdef LGT_MAC
...
// 	else
// 	{
// 		do_z_clearance(current_position[Z_AXIS] + z_dest);
// 	}
// #else
// 	if (z_dest > current_position[Z_AXIS]);
// 	do_z_clearance(z_dest);
...
// }
  ...
  do_z_clearance(z_dest); //MARIO: IMHO this should be sufficent to get it work correctly.
}
