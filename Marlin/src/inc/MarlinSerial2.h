...
/**
  MarlinSerial2.h - Hardware serial library for Wiring
...
#ifndef MARLINSERIAL2_H
#define MARLINSERIAL2_H
...
// Registers used by MarlinSerial2 class (expanded depending on selected serial port)
...
// 256 is the max TX buffer limit due to uint8_t head and tail.
 ...
 extern MarlinSerial2 customizedSerial3;
