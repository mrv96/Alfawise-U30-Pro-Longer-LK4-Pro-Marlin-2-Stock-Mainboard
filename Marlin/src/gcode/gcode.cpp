...
#include "../inc/MarlinSerial2.h"
#include "../feature/bedlevel/bedlevel.h"
#include "../feature/runout.h"
#include "../module/planner.h"
#include "../module/probe.h"
extern bool LGT_is_printing, LGT_stop_printing;
extern char leveling_sta;
extern LGT_SCR LGT_LCD;
extern E_MENU_TYPE menu_type;
extern void LGT_Pause_Move();
  ...
  switch (parser.command_letter) {
    ...
    case 'M': switch (parser.codenum) {
	  ...
	  case 2002:	// wait for levelling measuring
		  ...
		  LGT_LCD.LGT_Send_Data_To_Screen(ADDR_VAL_LEVEL_Z_UP_DOWN, probe.offset.z);
		  break;
	#endif // U20_Pro
